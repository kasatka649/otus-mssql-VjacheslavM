...
(SELECT ord.CustomerID, det.StockItemID,inv.BillToCustomerID,det.UnitPrice,det.Quantity,ord.OrderID FROM Sales.Orders AS ord
...
ON ItemTrans.StockItemID = CTE.StockItemID
WHERE CTE.BillToCustomerID != CTE.CustomerID
AND (Select SupplierId
FROM Warehouse.StockItems AS It
Where It.StockItemID = CTE.StockItemID) = 12
